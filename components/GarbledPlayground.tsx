...
export const GarbledPlayground: React.FC = () => {
  ...
  return (
    <section id="garbled-mpc" className="w-full max-w-7xl mx-auto px-6 md:px-10 py-16">
      <div className="card-white p-8 md:p-12 relative overflow-hidden shadow-card-elevated">
        <div className="max-w-2xl mb-8">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-50 border border-purple-100 text-coti-violet text-[12px] font-mono font-bold mb-3">
            <Cpu className="w-3.5 h-3.5 text-coti-violet" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-[#0D0E12] text-white p-6 md:p-8 rounded-2xl border border-border-subtle font-mono text-[12px] space-y-4 shadow-xl">
            <div className="flex items-center justify-between border-b border-gray-800 pb-3">
              <span className="text-coti-violet font-bold flex items-center gap-2">
                <Lock className="w-4 h-4 text-coti-emerald" />
            ...
            <div>
              <span className="text-[#9CA3AF] block mb-1 text-[11px]">COTI `gtAddress` Garbled Container:</span>
              <div className="p-3 rounded-xl bg-black/60 border border-purple-900/40 text-coti-cyan font-bold break-all">
                {garbledRecip.garbledCiphertext}
              </div>
            </div>

            <div>
              <span className="text-[#9CA3AF] block mb-1 text-[11px]">COTI `gtUint256` Garbled Container:</span>
              <div className="p-3 rounded-xl bg-black/60 border border-purple-900/40 text-coti-violet font-bold break-all">
                {garbledAmt.garbledCiphertext}
              </div>
            </div>

            <div className="pt-2 border-t border-gray-800 flex items-center justify-between text-[11px] text-[#9CA3AF]">
